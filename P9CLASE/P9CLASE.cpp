...
//Lighting
glm::vec3 lightPosition(0.0f, 1.0f, 3.0f);
...
//Nombres de las texturas a utilizar
...
void LoadTextures()
{
	//Para acceder a los archivos de la caprtea
	...
	t_azulejo = generateTextures("Texturas/azulejo.png", 0);
	t_roof= generateTextures("Texturas/roof.jpg", 0);
	t_log = generateTextures("Texturas/log.jpg", 0);
	t_roto = generateTextures("Texturas/roto.jpg", 0);
	t_pintura = generateTextures("Texturas/pintura.jpg", 0);
	t_cinderblock = generateTextures("Texturas/cinderblock.jpg", 0);
	...
	glBindTexture(GL_TEXTURE_2D, t_roof);
	glActiveTexture(GL_TEXTURE11);
	glBindTexture(GL_TEXTURE_2D, t_log);
	glActiveTexture(GL_TEXTURE12);
	glBindTexture(GL_TEXTURE_2D, t_roto);
	glActiveTexture(GL_TEXTURE13);
	glBindTexture(GL_TEXTURE_2D, t_pintura);
	glActiveTexture(GL_TEXTURE14);
	glBindTexture(GL_TEXTURE_2D, t_cinderblock);
...
void display(void)
{
	...
	model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
	lightingShader.setMat4("model", model);
	lightingShader.setInt("material_diffuse", t_roto);
	lightingShader.setInt("material_specular", t_caja_brillo);
	...
	model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
	lightingShader.setMat4("model", model);
	lightingShader.setInt("material_diffuse", t_pintura);
	lightingShader.setInt("material_specular", t_caja_brillo);
	...
	model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
	lightingShader.setMat4("model", model);
	lightingShader.setInt("material_diffuse", t_log);
	...
	model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
	lightingShader.setMat4("model", model);
	lightingShader.setInt("material_diffuse", t_cinderblock);
	lightingShader.setInt("material_specular", t_caja_brillo);
	...
	model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
	lightingShader.setMat4("model", model);
	lightingShader.setInt("material_diffuse", t_roof);
	lightingShader.setInt("material_specular", t_caja_brillo);
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Práctica 9- Fanny Rugerio", NULL, NULL);
    if (window == NULL)
    {
