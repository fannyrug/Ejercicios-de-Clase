...
void display(void)
{
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.0f, 0.3f, 0.4f));
	glDrawArrays(GL_QUADS, 0, 24);
	model = modelTemp;
	...
	model = glm::scale(model, glm::vec3(0.3, 0.25, 0.3));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.0f, 0.3f, 0.5f));
	glDrawArrays(GL_QUADS, 0, 24);
	model = modelTemp;
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 0.6f, 0.3f));
	glDrawArrays(GL_QUADS, 0, 24);
	model = modelTemp;
	...
	model = glm::scale(model, glm::vec3(0.4, 0.25, 0.3));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 0.6f, 0.2f));
	glDrawArrays(GL_QUADS, 0, 24);
	model = modelTemp;
	...
	model = glm::scale(model, glm::vec3(0.4, 0.25, 0.3));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 0.6f, 0.1f));
	glDrawArrays(GL_QUADS, 0, 24);
	model = modelTemp2;
	...
	model = glm::scale(model, glm::vec3(0.3, 0.25, 0.3));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.9f, 0.7f, 0.2f));
	glDrawArrays(GL_QUADS, 0, 24);
	model = modelTemp;
	...
	model = glm::scale(model, glm::vec3(0.3, 0.25, 0.3));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.9f, 0.7f, 0.1f));
	glDrawArrays(GL_QUADS, 0, 24);
	model = modelTemp;
	...
	model = glm::scale(model, glm::vec3(0.3, 0.25, 0.3));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.9f, 0.7f, 0.0f));
	glDrawArrays(GL_QUADS, 0, 24);
	model = modelTemp2;
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.0f, 0.8f, 0.8f));
	glDrawArrays(GL_QUADS, 0, 24);
	model = modelTemp;
	...
	model = glm::scale(model, glm::vec3(0.2, 0.25, 0.3));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.0f, 0.9f, 0.9f));
	glDrawArrays(GL_QUADS, 0, 24);
	model = modelTemp;
