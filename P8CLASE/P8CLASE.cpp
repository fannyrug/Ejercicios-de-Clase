...
/* ----------------   Práctica 8 --------------------------*/
/*-----------------    2019-2   ---------------------------*/
/*------------- Alumna: Fanny Berenice Rugerio Fernández Cobos ---------------*/
...
void myData()
{
	float vertices[] = {
		                  //coordenadas XY
-0.5f, -0.5f, 0.5f,       0.5f, 0.33f,  //Frontal
 0.5f, -0.5f, 0.5f,       0.25f, 0.33f,
 0.5f, 0.5f, 0.5f,         0.25f, 0.66f,
-0.5f, 0.5f, 0.5f,         0.5f, 0.66f,  

 0.5f, -0.5f, -0.5f,      0.75f, 0.66f,	// Trasera
-0.5f, -0.5f, -0.5f,      0.75f,0.33f,  //V3
-0.5f, 0.5f, -0.5f,      1.0f, 0.33f,	//V7
 0.5f, 0.5f, -0.5f,       1.0f, 0.66f,	//V6

-0.5f, 0.5f, 0.5f,       0.0f, 0.66f,	//V4  Izq
-0.5f, 0.5f, -0.5f,      0.0f, 0.33f,	//V7
-0.5f, -0.5f, -0.5f,     0.25f, 0.33f,	//V3
-0.5f, -0.5f, 0.5f,      0.25f, 0.66f,	//V0
...
-0.5f, 0.5f, 0.5f,        0.25f, 1.0f,	//V4  Sup
0.5f, 0.5f, 0.5f,         0.25f, 0.66f,	//V5
0.5f, 0.5f, -0.5f,        0.5f, 0.66f,	//V6
-0.5f, 0.5f, -0.5f,       0.5f, 1.0f,	//V7
...
0.5f, -0.5f, 0.5f,       0.5f, 0.33f,	//V1
	...
	unsigned char *data = stbi_load("Cube01.png", &width, &height, &nrChannels, 0);
	if (data)
	{
		// IMPORTANT note
...
void display(void)
{
	...
	view = glm::translate(view, glm::vec3(movX, movY, movZ));//movX para ser dinamico
	// pass them to the shaders
	projectionShader.setMat4("model", model);
	projectionShader.setMat4("view", view);
	// note: currently we set the projection matrix each frame, but since the projection matrix rarely changes it's often best practice to set it outside the main loop only once.
